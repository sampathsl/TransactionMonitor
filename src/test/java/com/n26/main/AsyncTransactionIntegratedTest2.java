...
/**
 * Created by SAMPATH on 05/06/2017.
 ...
 */
public class AsyncTransactionIntegratedTest2 extends AbstractControllerTest {
    ...
    private List<Transaction> getSampleOldTransactions() {
        ...
        IntStream.range(0, 100).forEach(e -> {
            transactions.add(new Transaction(50,(Instant.now().getEpochSecond() * 1000 - 30000)));
        });
        return transactions;
    }
